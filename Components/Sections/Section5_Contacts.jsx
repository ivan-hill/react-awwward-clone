        ...
        <div className="Section5_Contacts">
          <div>
            ...
            <div className="articles_S5">
              ...
              <p className="pCaption__s5">
                You can call, write or contact us on social media.
                <br />
          ...
          <div className="Info">
            ...
            <div className="defaultInfo">
              ...
              >
                <p>EMAIL</p>
                <p>ivan.hill81@gmail.com</p>
              </a>
              <a
                href="https://meadlight.com/en"
                target="_blank"
                className="email"
                rel="noreferrer"
              >
              ...
              <div className="socials">
                ...
                <a
                  href="https://www.instagram.com/ivan_hill81/"
                  target="_blank"
                  rel="noreferrer"
                >
